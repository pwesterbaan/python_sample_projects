		...
		<div id="content">
			<?php if (in_array($user_id,$admin_list)): ?>
				<?php if (isset($percentages) && $percentages != NULL): ?>
					<h1>FPCI Activity Percentage Entry for <?php echo strtoupper(substr(preg_replace('/[0-9]+/', '', md5($percentages['user_id'])),0,6)) ?> for <?php echo $percentages['year']-1;echo '-'; echo $percentages['year']; ?></h1>
