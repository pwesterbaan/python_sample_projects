...
<head>
	...
	<title>FPCI DEMO | Admin View Percentage Entry</title>
		...
		<div id="content">
			<?php if (in_array($user_id,$admin_list)): ?>
				<?php if (isset($person_id) && $on_evaluation_list && $percentages == NULL): ?>
					<h1>FPCI Activity Percentage Entry for <?php echo strtoupper(substr(preg_replace('/[0-9]+/', '', md5($person_user_id)),0,6)); ?> for <?php echo $current_evaluation_year-1;echo '-'; echo $current_evaluation_year; ?></h1>
