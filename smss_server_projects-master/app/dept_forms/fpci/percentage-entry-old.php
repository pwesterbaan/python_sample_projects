...
<body>
	<div id="main">
		...
		<div id="content">
			<h1>Activity Percentage Entry</h1>
			
			<?php if ($person_id != 0 && $eligible_for_entry): ?>
				<?php if ($accepting_edits): ?>
					<p>Fill in the blue bordered boxes. All other numbers are calculated automatically. The semester percentage totals for fall and spring as well as the overall percentage total should each equal 100%. The summer percentage total should be no more than 100%. 
						
					<p>The cutoff date for changes is <?php echo date("F j, Y, g:i a",$percentage_entry_cutoff); ?>.</p>
					
					<p><a href="javascript:toggle_explanation();">How summer and overall percentages are calculated</a></p>
					...
					<table class="styled">
						...
						<tr>
							<td>Teaching</td>
							<td class="text-right">Summer course credits <input type="text" size="2" name="summer_course_credits" id="summer_course_credits" value="<?php echo isset($percentages['summer_course_credits']) ? $percentages['summer_course_credits'] : "0";?>"> <input type="text" size="2" name="summer_teaching_percentage" id="summer_teaching_percentage" value="<?php echo isset($percentages['summer_teaching_percentage']) ? $percentages['summer_teaching_percentage'] : "0";?>" tabindex="-1" readonly></input>%</td>
							<td><input type="text" size="2" name="fall_teaching_percentage" id="fall_teaching_percentage" class="fall teaching" value="<?php echo isset($percentages['fall_teaching_percentage']) ? $percentages['fall_teaching_percentage'] : "0";?>"></input>%</td>
							<td><input type="text" size="2" name="spring_teaching_percentage" id="spring_teaching_percentage" class="spring teaching" value="<?php echo isset($percentages['spring_teaching_percentage']) ? $percentages['spring_teaching_percentage'] : "0";?>"></input>%</td>
							<td><input type="text" size="2" name="overall_teaching_percentage" id="overall_teaching_percentage" value="<?php echo isset($percentages['overall_teaching_percentage']) ? $percentages['overall_teaching_percentage'] : "0";?>"tabindex="-1" readonly></input>%</td>
						</tr>
				
						<tr>
							<td>Research</td>
							<td class="text-right">Summer research days <input type="text" size="2" name="summer_research_days" id="summer_research_days" value="<?php echo isset($percentages['summer_research_days']) ? $percentages['summer_research_days'] : "0";?>"> <input type="text" size="2" name="summer_research_percentage" id="summer_research_percentage" value="<?php echo isset($percentages['summer_research_percentage']) ? $percentages['summer_research_percentage'] : "0";?>" tabindex="-1" readonly></input>%</td>
							<td><input type="text" size="2" name="fall_research_percentage" id="fall_research_percentage" class="fall research" value="<?php echo isset($percentages['fall_research_percentage']) ? $percentages['fall_research_percentage'] : "0";?>"></input>%</td>
							<td><input type="text" size="2" name="spring_research_percentage" id="spring_research_percentage" class="spring research" value="<?php echo isset($percentages['spring_research_percentage']) ? $percentages['spring_research_percentage'] : "0";?>"></input>%</td>
							<td><input type="text" size="2" name="overall_research_percentage" id="overall_research_percentage" value="<?php echo isset($percentages['overall_research_percentage']) ? $percentages['overall_research_percentage'] : "0";?>" tabindex="-1" readonly></input>%</td>
						</tr>
				
						<tr>
							<td>Service</td>
							<td class="text-right">Summer service days <input type="text" size="2" name="summer_service_days" id="summer_service_days" value="<?php echo isset($percentages['summer_service_days']) ? $percentages['summer_service_days'] : "0";?>"> <input type="text" size="2" name="summer_service_percentage" id="summer_service_percentage" value="<?php echo isset($percentages['summer_service_percentage']) ? $percentages['summer_service_percentage'] : "0";?>" tabindex="-1" readonly></input>%</td>
							<td><input type="text" size="2" name="fall_service_percentage" id="fall_service_percentage" class="fall service" value="<?php echo isset($percentages['fall_service_percentage']) ? $percentages['fall_service_percentage'] : "0";?>"></input>%</td>
							<td><input type="text" size="2" name="spring_service_percentage" id="spring_service_percentage" class="fall service" value="<?php echo isset($percentages['spring_service_percentage']) ? $percentages['spring_service_percentage'] : "0";?>"></input>%</td>
							<td><input type="text" size="2" name="overall_service_percentage" id="overall_service_percentage" value="<?php echo isset($percentages['overall_service_percentage']) ? $percentages['overall_service_percentage'] : "0";?>" tabindex="-1" readonly></input>%</td>
						</tr>
				
						<tr>
							<td>Semester Totals</td>
							<td class="text-right"><input type="text" size="2" id="summer_percentage_total" value="0" tabindex="-1" readonly></input>%</td>
							<td><input type="text" size="2" id="fall_percentage_total" value="0" tabindex="-1" readonly></input>%</td>
							<td><input type="text" size="2" id="spring_percentage_total" value="0" tabindex="-1" readonly></input>%</td>
							<td><input type="text" size="2" id="overall_percentage_total" value="0" tabindex="-1" readonly></input>%</td>
						</tr>
					</table>
