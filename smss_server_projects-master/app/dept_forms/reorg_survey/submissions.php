...
$get_submissions = mysql_query('SELECT id,last_updated FROM `reorg_survey`');
if ($get_submissions)
{
	$submissions = array();
...
<head>
	...
	<title>Restructuring Survey Submissions</title>
...
<body>
	<div id="main">
		...
		<div id="content">
			<h1 style="text-align:center;">Restructuring Survey Results</h1>
			
			<?php echo isset($confirmation) ? '<p id="confirmation">'.$confirmation.'</p>' : "</br>"; ?>
			
			<center>
				<p><h3><a href="view_responses.php">View Survey Response Data</a></h3></p><br>
			...
			<table style="margin-right:auto; margin-left:auto;">
				...
				<?php foreach ($submissions as $sub): ?>
					<tr>
						...
						<td style="text-align:center;"><a href="view_submission.php?id=<?php echo $sub['id'] ?>">View Responses</a></td>
					</tr>
				<?php endforeach; ?>
			</table></p>
			</center>
