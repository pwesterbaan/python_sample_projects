    ...
    def union(self,p,q):
        ...
        if a is not b:
            if a._size > b._size:
                b._parent = a
                a._size += b._size
#                 a._interiorEdges.append(interiorEdge)
#                 a._outgoingEdges.append(b._outgoingEdges)
#                 while interiorEdge in a._outgoingEdges:
#                     a._outgoingEdges.remove(interiorEdge)
            else:
                a._parent = b
                b._size += a._size
#                 b._interiorEdges.append(interiorEdge)
#                 b._outgoingEdges.append(a._outgoingEdges)
#                 while interiorEdge in b._outgoingEdges:
#                     b._outgoingEdges.remove(interiorEdge)